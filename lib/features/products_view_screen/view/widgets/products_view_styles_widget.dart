...
class GridViewStyle extends StatelessWidget {
  const GridViewStyle({super.key, this.homeProductsModel});
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                        ...
                        image: DecorationImage(
                            fit: BoxFit.fill,
                            image: AssetImage('${homeProductsModel!.image}'))),
                    child: Column(
                  ...
                  Column(
                    ...
                    children: [
                      ...
                      SizedBox(
                        width: 157.w,
                        child: Text(
                          'Post-it 654-5uc Sticky Notes,3*3 in assorted,pk24',
                          maxLines: 2,
                          style: TextStyle(
                              overflow: TextOverflow.ellipsis,
                              fontFamily: 'Lato-Regular.ttf',
